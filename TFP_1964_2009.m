...
del=del'./12;
DEL=[zeros(size(del));del; 2.*del; 3.*del; 4.*del; 5.*del; 6.*del; 7.*del; 8.*del; 9.*del ; 10.*del; 11.*del];% 1 week = 1/12 quarter
...
% Stochastic process -- replicates labor productivity at weekly frequency
