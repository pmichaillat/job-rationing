...
rep=30;%number samples - 10,000 in shimer(2005)
cut=100;
...
TAB3=[dev1,autoc1,Q1];
%fid = fopen('table/meanHP0098.txt', 'wt');
fid = fopen('table/meanHP054.txt', 'wt');
fprintf(fid, '& %4.3f  & %4.3f & %4.3f & %4.3f  & %4.3f & %4.3f \\\\ \n', TAB3);
fclose(fid);


TAB3=[dev2,autoc2,Q2];
%fid = fopen('table/varianceHP0098.txt', 'wt');
fid = fopen('table/varianceHP054.txt', 'wt');
fprintf(fid, ' & (%4.3f) & (%4.3f) & (%4.3f) & (%4.3f)  & (%4.3f) & (%4.3f)\\\\ \n', TAB3);
fclose(fid);
