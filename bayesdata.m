...
fid=fopen('/home/pascal/Documents/Data/US_DATA/FRED_PROD.txt');%already quarterly, in logs
...
ecirwhp=hpfilter(ECIRW,whp);%detrended unemp.
ecirwx=w0.*exp(ecirwhp);% mean of w0
...
% save('logbayesAER.mat','prod','n','w','th')