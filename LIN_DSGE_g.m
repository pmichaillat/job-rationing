...
function [AMAT,BMAT,SS,xeq,xvari,s3]=LIN_DSGE_g(w,gamma,alpha)

global delta eta c a sigma_a omega rho_a s z q f u varsigma uinv zeta
...
% Wage: gradual adjustment
cof(7,wzero)=1;
cof(7,azero)=-zeta.*gamma;
cof(7,wlag)=-(1-zeta);
