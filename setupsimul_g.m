...
[AMAT,BMAT,SS,xeq,xvari]=LIN_DSGE_g(w,gamma,alpha); % To compute and plot impulse response use reduced form solution: x_t = amat * x_{t-1} + b * shock