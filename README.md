...
* `compare_HP.m` – Run the entire numerical analysis presented in the manuscript for a  HP-filter parameter of $1600$ instead of $100,000$. Results are reported in Section A4.
